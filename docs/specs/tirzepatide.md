---
title: "Tirzepatide — Technical Specification"
description: "Technical specification for Tirzepatide, a dual GIPR/GLP-1 receptor agonist with 39 amino acids and C20 fatty diacid linker, for metabolic research applications."
schema_type: FAQPage
faq_json:
  - q: "What is the purity level of Tirzepatide?"
    a: "Tirzepatide is supplied at ≥99% purity verified by HPLC analysis with full Certificate of Analysis documentation."
  - q: "How should Tirzepatide be stored for research use?"
    a: "Store lyophilized Tirzepatide at -20°C for long-term stability. Reconstituted solutions should be stored at 2-8°C and used within 7-14 days."
  - q: "What is the molecular structure of Tirzepatide?"
    a: "Tirzepatide is a 39-amino acid dual GIPR/GLP-1 receptor agonist with a C20 fatty diacid linker conjugated to Lys²⁰ for extended pharmacokinetics, with a molecular weight of approximately 4,813.5 Da."
  - q: "Is Tirzepatide suitable for human use?"
    a: "No. Tirzepatide is labeled FOR LABORATORY RESEARCH USE ONLY and is not approved by regulatory authorities for human therapeutic or diagnostic use."
---
